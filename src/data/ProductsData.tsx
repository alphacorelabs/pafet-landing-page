...
export const productsData: ProductProps[] = [
  {
    ...
    subHeading:
      "Your clients pay into your personal USD account (in your name) like they would any US-based business. Funds arrive instantly.",
    benefits: [
    ...
    callToActionUrl: "https://app.usepafet.com",
  },

  {
    ...
    subHeading:
      "Create branded invoices in minutes. Add your services, set payment terms, and send. Pafet tracks when clients view your invoice and sends automatic reminders so you never have to chase payments.",
    benefits: [
...

  {
    ...
    subHeading:
      "Get a virtual card issued instantly to your dashboard. Perfect for software subscriptions, digital advertising, and any online purchase worldwide. Top up from your USD balance instantly. Freeze or unfreeze anytime from your phone.",
    benefits: [
      "Accepted globally",
      "Issued instantly",
...

  {
    ...
    subHeading:
      "No forced conversions. No terrible bank rates. You decide when to convert, and you see exactly what you'll get. We show you the real mid-market rate. Our 1.5% fee is clearly stated. Withdraw to any Nigerian bank or mobile wallet. Funds arrive in hours, not days.",
    benefits: [
    ...
    callToActionUrl: "https://app.usepafet.comhello@usepafet.com",
  },
];
